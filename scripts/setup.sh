...
echo "  2. Verify UEEditorMCP plugin is enabled (Edit > Plugins)"
echo "  3. Check Output Log for 'MCP Server started on port 55558'"
echo "  4. Run: cd $PYTHON_DIR && source .venv/bin/activate && python3 -m src ping"
