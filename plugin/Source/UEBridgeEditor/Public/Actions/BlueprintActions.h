 ...
 *   - path: Asset path
 */
class UEBRIDGEEDITOR_API FCreateBlueprintAction : public FBlueprintAction
{
public:
 ...
 */
class UEBRIDGEEDITOR_API FCompileBlueprintAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FAddComponentToBlueprintAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FSpawnBlueprintActorAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FSetComponentPropertyAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 *   - component: Component name
 */
class UEBRIDGEEDITOR_API FSetStaticMeshPropertiesAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 *   - component: Component name
 */
class UEBRIDGEEDITOR_API FSetPhysicsPropertiesAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 *   - success: Whether property was set
 */
class UEBRIDGEEDITOR_API FSetBlueprintPropertyAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 *
 * Sets a property on an inherited component (e.g., CharacterMovement on a Character Blueprint).
 * Unlike set_component_property which only works with SCS components, this action
 * accesses components from the Blueprint's Class Default Object (CDO).
 *
 * Parameters:
 *   - blueprint_name (required): Name of the Blueprint
 *   - component_name (required): Name of the inherited component (e.g., "CharacterMovement")
 *   - property_name (required): Property to set (e.g., "bCanCrouch")
 *   - property_value (required): Value to set
 */
class UEBRIDGEEDITOR_API FSetInheritedComponentPropertyAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context, FString& OutError) override;
	virtual FString GetActionName() const override { return TEXT("set_inherited_component_property"); }
};
 ...
 */
class UEBRIDGEEDITOR_API FCreateColoredMaterialAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FSetBlueprintParentClassAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FAddBlueprintInterfaceAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 *   - blueprint_name, interface_name
 */
class UEBRIDGEEDITOR_API FRemoveBlueprintInterfaceAction : public FBlueprintAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
