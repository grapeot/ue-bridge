 ...
 */
class UEBRIDGEEDITOR_API FGraphDescribeEnhancedAction : public FBlueprintNodeAction
{
public:
 ...
 */
struct UEBRIDGEEDITOR_API FPatchOp
{
	/** Operation type */
 ...
 */
struct UEBRIDGEEDITOR_API FPatchOpResult
{
	int32 OpIndex = -1;
	FString OpType;
	bool bSuccess = false;
 ...
 */
class UEBRIDGEEDITOR_API FApplyPatchAction : public FBlueprintNodeAction
{
 ...
 */
class UEBRIDGEEDITOR_API FValidatePatchAction : public FBlueprintNodeAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FExportNodesToTextAction : public FBlueprintNodeAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FImportNodesFromTextAction : public FBlueprintNodeAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
