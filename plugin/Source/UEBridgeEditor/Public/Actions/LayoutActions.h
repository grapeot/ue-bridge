...
class UEBRIDGEEDITOR_API FBlueprintAutoLayout
{
public:
	/**
 ...
 */
class UEBRIDGEEDITOR_API FAutoLayoutSelectedAction : public FEditorAction
{
public:
 ...
 */
class UEBRIDGEEDITOR_API FAutoLayoutSubtreeAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FAutoLayoutBlueprintAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
 ...
 */
class UEBRIDGEEDITOR_API FLayoutAndCommentAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context) override;
