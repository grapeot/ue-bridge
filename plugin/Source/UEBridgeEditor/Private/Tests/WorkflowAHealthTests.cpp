...
namespace UEBridgeEditor::Tests
{
...
bool FUEEditorMCPIsReadyCommandTest::RunTest(const FString& Parameters)
{
	...
	const TSharedPtr<FJsonObject>& ResultObject = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, Response);
	...
	UEBridgeEditor::Tests::ReadBoolField(*this, ResultObject, TEXT("editor_valid"), bEditorValid);
	UEBridgeEditor::Tests::ReadBoolField(*this, ResultObject, TEXT("world_ready"), bWorldReady);
	UEBridgeEditor::Tests::ReadBoolField(*this, ResultObject, TEXT("asset_registry_ready"), bAssetRegistryReady);
	UEBridgeEditor::Tests::ReadBoolField(*this, ResultObject, TEXT("ready"), bReady);
...
bool FUEEditorMCPWorkflowAHealthSurfaceTest::RunTest(const FString& Parameters)
{
	...
	const TSharedPtr<FJsonObject>& LogsResult = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, LogsResponse);
...
bool FUEEditorMCPLogControlSurfaceTest::RunTest(const FString& Parameters)
{
	...
	const TSharedPtr<FJsonObject>& ClearResult = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, ClearResponse);
	...
	const TSharedPtr<FJsonObject>& AssertResult = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, AssertResponse);
...
bool FUEEditorMCPPIESmokeLifecycleTest::RunTest(const FString& Parameters)
{
	...
	for (int32 Attempt = 0; Attempt < 40; ++Attempt)
	{
		...
		const TSharedPtr<FJsonObject>& StateResult = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, StateResponse);
...
bool FUEEditorMCPCreateAndCompileBlueprintTest::RunTest(const FString& Parameters)
{
	...
	const TSharedPtr<FJsonObject>& CreateResult = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, CreateResponse);
	...
	const TSharedPtr<FJsonObject>& CompileResult = UEBridgeEditor::Tests::GetFlatSuccessObject(*this, CompileResponse);
