...
namespace UEBridgeEditor::NodeTests
{
...
bool FUEBridgeEditorGraphNodeWorkflowTest::RunTest(const FString& Parameters)
{
	...
	const TSharedPtr<FJsonObject>& BranchResult = UEBridgeEditor::NodeTests::GetFlatSuccessObject(*this, BranchResponse);
	...
	const TSharedPtr<FJsonObject>& FunctionResult = UEBridgeEditor::NodeTests::GetFlatSuccessObject(*this, FunctionResponse);
	...
	const TSharedPtr<FJsonObject>& BranchPinsResult = UEBridgeEditor::NodeTests::GetFlatSuccessObject(*this, BranchPinsResponse);
	...
	TestNotNull(TEXT("branch node should expose Then pin"), UEBridgeEditor::NodeTests::FindPinByName(*BranchPins, TEXT("Then")));
	...
	const TSharedPtr<FJsonObject>& FunctionPinsResult = UEBridgeEditor::NodeTests::GetFlatSuccessObject(*this, FunctionPinsResponse);
	...
	TestNotNull(TEXT("function node should expose execute pin"), UEBridgeEditor::NodeTests::FindPinByName(*FunctionPins, TEXT("execute")));
	...
	const TSharedPtr<FJsonObject>& FunctionPinsAfterConnectResult = UEBridgeEditor::NodeTests::GetFlatSuccessObject(*this, FunctionPinsAfterConnectResponse);
	...
	const TSharedPtr<FJsonObject>* ExecutePin = UEBridgeEditor::NodeTests::FindPinByName(*FunctionPinsAfterConnect, TEXT("execute"));
