...
TSharedPtr<FJsonObject> FDeleteActorAction::ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context)
{
	...
	UE_LOG(LogMCP, Log, TEXT("UEBridgeEditor: Deleted actor '%s'"), *ActorName);
...
TSharedPtr<FJsonObject> FSetActorPropertyAction::ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FUEEditorContext& Context)
{
	...
	UE_LOG(LogMCP, Log, TEXT("UEBridgeEditor: Set property '%s' on actor '%s'"), *PropertyName, *ActorName);
		...
		for (UPackage* Package : DirtyPackages)
		{
			...
			if (FPackageName::TryConvertLongPackageNameToFilename(PackageName, PackageFilename, Extension))
			{
				...
				if (UPackage::SavePackage(Package, AssetToSave, *PackageFilename, SaveArgs))
				{
					...
					UE_LOG(LogMCP, Log, TEXT("UEBridgeEditor SaveAll: Saved %s"), *PackageName);
				}
			}
		}
	}
