...
#include "UEBridgeEditorModule.h"
...
{
	UE_LOG(LogMCP, Log, TEXT("UEBridgeEditor: Module shutting down"));
...
bool FUEBridgeEditorModule::IsAvailable()
{
	return FModuleManager::Get().IsModuleLoaded("UEBridgeEditor");
}

FUEBridgeEditorModule& FUEBridgeEditorModule::Get()
{
	return FModuleManager::LoadModuleChecked<FUEBridgeEditorModule>("UEBridgeEditor");
}


void FUEBridgeEditorModule::RegisterAutoLayoutCommands()
{
	...
	AutoLayoutCommandList->MapAction(
		...
		FExecuteAction::CreateStatic(&UEBridgeEditorModuleAutoLayout::ExecuteAutoLayoutSmart));

	AutoLayoutCommandList->MapAction(
		FBlueprintAutoLayoutCommands::Get().AutoLayoutSubtree,
		FExecuteAction::CreateStatic(&UEBridgeEditorModuleAutoLayout::ExecuteAutoLayoutSubtree));

	AutoLayoutCommandList->MapAction(
		FBlueprintAutoLayoutCommands::Get().AutoLayoutGraph,
		FExecuteAction::CreateStatic(&UEBridgeEditorModuleAutoLayout::ExecuteAutoLayoutGraph));
...
void FUEBridgeEditorModule::UnregisterAutoLayoutCommands()
{
